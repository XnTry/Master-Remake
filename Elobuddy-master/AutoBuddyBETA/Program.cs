    ...
    internal static class Program
    {
        ...
        {       
            ...
            if (myHero.Hero == Champion.Kalista)
            {
                ...
                Chat.Print("AutoBuddyBETA: AutoBlackSpear loaded: Thanks @Enelx");
            ...
            Chat.Print("AutoBuddyBETA: Will Starting in 20 seconds.", System.Drawing.Color.LimeGreen);
            Core.DelayAction(Start, 20000);
            ...
            menu.Add("l1", new Label("By Christian Brutal Sniper - Maintained by DevAkumetsu and TheYasuoMain"));
